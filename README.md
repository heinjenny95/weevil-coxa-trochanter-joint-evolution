...
- `data/screw_geometry`: exported geometry measurements, the corrected
  60-specimen shape--geometry analysis dataset, sample-flow audit and summary
  statistics used in the revised manuscript.
...
The comparative analyses use 15 taxonomic proxy tips because the available
...
distributed with the supplementary source data.
...
specimen-to-proxy mapping and screw-geometry results are included under
`data/`. Tomographic data, processed meshes, the full morphometric scores,
