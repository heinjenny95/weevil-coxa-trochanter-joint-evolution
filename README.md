...
- `data/screw_geometry`: all 64 robust helix fits, 12,800 bootstrap draws,
  main 63-specimen and high-confidence 53-specimen analysis tables, QC figures
  and a compact interpretation audit.
...
use only matched qualifying specimens and therefore contain 14 main-dataset or
